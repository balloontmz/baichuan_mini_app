                ...
                <div class="layui-header d-print-none">
                    ...
                    <ul class="layui-nav layui-layout-left">
                        <li class="layui-nav-item layadmin-flexible" lay-unselect>
                            <a href="javascript:;" class="yd-toggle-class" data-class="layadmin-side-shrink" data-target="#LAY_app" title="侧边伸缩">
                                <i class="layui-icon layui-icon-shrink-right yd-toggle-class" data-class="layui-icon-spread-left" data-target="#LAY_app_flexible" id="LAY_app_flexible"></i>
                            </a>
                        </li>
