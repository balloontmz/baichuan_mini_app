...
<div class='m-3'>
    <div class="d-flex align-items-center justify-content-between">
        <h2 class="font-weight-bold">一级属性列表</h2>
        <div class="">
            <button type="button" class="layui-btn layui-btn-normal yd-dialog"
                    data-url="/attribute/first_attribute/add">新增
            </button>
        </div>
    </div>
    <table class="layui-table" lay-data="{ url:'/attribute/first_attribute/index.json', page:false, id:'test'}"
           lay-filter="test">
        <thead>
        <tr>
...
<script type="text/html" id="barDemo">
    <a class="layui-btn layui-btn-normal layui-btn-xs yd-dialog"
       data-url="/attribute/first_attribute/add?first_attribute_id={{d.id}}" lay-event="edit">修改</a>
