...
<div class='m-3'>
    <div class="d-flex align-items-center justify-content-between">
        <h2 class="font-weight-bold">产品列表</h2>
        <div class="">
            <button type="button" class="layui-btn layui-btn-normal yd-dialog" data-url="/product/index/add">新增
            </button>
        </div>
    </div>
    <blockquote class="layui-elem-quote news_search mt-1">
        <form class="layui-form">
            <div class="layui-inline">
                <input class="layui-input" value="" id="query" name="query" autocomplete="off"
                       placeholder="请输入产品名称"
                       style="width: 300px;">
            </div>
    ...
    <table class="layui-table" lay-data="{ url:'/product/index/index.json', page:true, id:'test'}"
           lay-filter="test">
        <thead>
        <tr>
