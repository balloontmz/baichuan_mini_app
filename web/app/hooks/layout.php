            ...
            <ul class="" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
                <?php if ($loginUser->type == "admin") { ?>
                    <li class="layui-nav-item  <?= $sidemenu == "user" ? " layui-nav-itemed layui-this" : "" ?>">
                        <a href="javascript:;" class="yd-popper-trigger" id="menu-item-user" data-popper-position="left"
                           data-popper-target="user">
                            <i class="iconfont icon-gongzuotai"></i>
                            <cite>用户管理</cite>
                        </a>
                        <div class="yd-popper-content popper yd-mousetoggle-class" data-target="menu-item-user"
                             data-class="menu-item-hover" id="user" style="display: none">
                ...
                <?php } else { ?>
                    <li class="layui-nav-item  <?= $sidemenu == "" ? " layui-nav-itemed layui-this" : "" ?>">
                        <a href="/user/index/index" class="yd-popper-trigger" id="menu-item-user"
                ...
                <?php if ($loginUser->type == "admin") { ?>
                    <li class="layui-nav-item  <?= $sidemenu == "product_quote" ? " layui-nav-itemed layui-this" : "" ?>">
                        <a href="javascript:;" class="yd-popper-trigger" id="menu-item-quote"
                           data-popper-position="left"
                    ...
                    <li class="layui-nav-item <?= $sidemenu == "product" ? "layui-nav-itemed layui-this" : "" ?>">
                        <a href="javascript:;" class="yd-popper-trigger" id="menu-item-product"
                           data-popper-position="left"
