...
abstract class YZE_Model extends YZE_Object {
    ...
    public function get_table() {
        ...
        $result = YZE_Hook::do_hook("get_table", $data);
        return $result["table"];
    }
    ...
    public function update_version() {
        ...
        switch ($this->getFieldType($this->get_version_name())) {
            case "integer":
            case "float": $new_value = $new_value + 1;
                break;
            case "date": $new_value = date("Y-m-d H:i:s");
                break;
        }
